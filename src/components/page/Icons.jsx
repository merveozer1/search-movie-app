      ...
      <div className="flexbox">
        <div className="fav-btn">
          <div className="favorites"
            style={{ display: "flex", flexDirection: "column", width: "auto", margin: "auto" }}>
            ...
            <button style={{ margin: "5px" }} onClick={() => dispatch(addSeenList(props.movieId, props.movieTitle))}>
              <svg className={`${props.isRead === true ? 'bookmark' : ''}`} width={'20px'} height={'20px'} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">  <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" /></svg>
            </button>
          </div>
        </div>
      </div>
